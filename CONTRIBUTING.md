# Contributing to Neurological Disease Ontology

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to ND. 
...
The Neurological Disease Ontology team strives to create a
...
Please use our [Issue Tracker](https://github.com/addiehl/neurological-disease-ontology/issues/) for reporting problems with the ontology. 
...
either as a primary term or a synonym term. You can search for your term using [OLS](http://www.ebi.ac.uk/ols/ontologies/nd).
...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/addiehl/neurological-disease-ontology/issues/).

It is important to remember that it takes a lot of time for curators to process issues submitted to the tracker.
To make this work easier, please always use issue templates if they are available (https://github.com/addiehl/neurological-disease-ontology/issues/new/choose).
